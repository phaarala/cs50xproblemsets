// Implement a program that determines the winner of a short Scrabble-like game. Your program should
// prompt for input twice: once for "Player 1" and once for "Player 2". Then, depending on which
// player scores the most points, your program should either print "Player 1 wins!", "Player 2
// wins!", or "Tie!" if the score is the same for both players.
...
int calculate_score(string player_input)
{
    ...
    for (int i = 0; i < word_length; i++)
    {
        ...
        {
            player_score += letter_values[player_input[i] - 'A'];
        }
